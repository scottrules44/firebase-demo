...
-- setup
local secretStuff = require("secretStuff")
firebase.myUrl = secretStuff.myUrl
firebase.myKey = secretStuff.myKey
firebase.databaseSecret = secretStuff.databaseSecret
--
